...
This table lists the configuration variables required to operate Metasponse. These variables are specified when configuring a Metasponse asset in Splunk SOAR.
